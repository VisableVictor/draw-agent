...
name: zine-poster
description: >-
  从主题/情绪/文字生成极简杂志风纸质海报（无需提供照片）。日韩独立杂志风格：
  大面积留白、旧纸质感、实验排版、克制色彩。给一个词、一句话、一种心情即可出图。
  Use when user mentions 杂志风海报、zine海报、极简海报、纸质海报、
  诗意海报、独立杂志风、editorial poster、氛围海报、情绪海报。
  不用于：有照片输入的海报（用 scenes-gathered-zine 或 scene-distillation-zine）、
  办公海报（用 doneai）。
alwaysApply: false
globs: []
---
